...
export default function EntrevistaPage() {
  ...
  return (
    <>
    <div className="space-y-6 text-slate-900 dark:text-white animate-fade-in max-w-5xl mx-auto">
      <button
      ...
      <div className="bg-white dark:bg-slate-900 border border-purple-300 dark:border-slate-800 rounded-2xl overflow-hidden shadow-lg">
        ...
        <form id="entrevistaForm" ref={formRef} onSubmit={handleSubmit} onChange={handleFormChange} className="p-8 text-sm text-slate-900 dark:text-white space-y-10 overflow-y-auto">
          <div>
