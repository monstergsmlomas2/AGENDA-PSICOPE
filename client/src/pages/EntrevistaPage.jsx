...
export default function EntrevistaPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Entrevista guardada', 'Â¡Entrevista de AdmisiÃ³n guardada exitosamente!');
        ...
        <div className="bg-purple-100/50 dark:bg-slate-950 border-b border-purple-300 dark:border-slate-800 px-8 py-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 font-bold dark:text-slate-600 dark:text-teal-400 flex items-center gap-3">
              <FileText size={24} /> Entrevista de AdmisiÃ³n
            </h1>
        ...
        <form id="entrevistaForm" onSubmit={handleSubmit} className="p-8 text-sm text-slate-900 dark:text-slate-300 space-y-10 overflow-y-auto">
          ...
          <section className="space-y-4">
            ...
            <div className="flex flex-wrap gap-6 bg-purple-100/50 dark:bg-slate-950 p-4 rounded-xl border border-purple-300 dark:border-slate-800">
              <label className="flex items-center gap-2 cursor-pointer font-medium"><input type="checkbox" name="apoyo_acompanante" defaultChecked={entrevista?.apoyo_acompanante} className="accent-pink-500 dark:accent-teal-500 w-4 h-4" /> AcompaÃ±ante TerapÃ©utico</label>
              <label className="flex items-center gap-2 cursor-pointer font-medium"><input type="checkbox" name="apoyo_maestra" defaultChecked={entrevista?.apoyo_maestra} className="accent-pink-500 dark:accent-teal-500 w-4 h-4" /> Maestra de InclusiÃ³n</label>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h4 className="text-slate-900 font-bold dark:text-slate-600 dark:text-teal-400 font-bold">HÃ¡bitos Diarios</h4>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-purple-100/50 dark:bg-slate-950 p-5 rounded-xl border border-purple-300 dark:border-slate-800">
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-3 text-sm font-medium"><input type="checkbox" name="motricidad_acorde" defaultChecked={entrevista?.motricidad_acorde} className="accent-pink-500 dark:accent-teal-500 w-4 h-4" /> Â¿Es acorde a la edad?</label>
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-3 text-sm font-medium"><input type="checkbox" name="motricidad_pinza" defaultChecked={entrevista?.motricidad_pinza} className="accent-pink-500 dark:accent-teal-500 w-4 h-4" /> Pinza fina / Toma el lÃ¡piz en pinza</label>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div><label className="text-slate-900 font-bold dark:text-pink-600 dark:text-slate-500 text-xs uppercase font-semibold">SocializaciÃ³n y Juego</label><textarea name="socializacion" defaultValue={entrevista?.socializacion} rows="2" className="w-full border border-purple-300 dark:bg-slate-950 dark:border-slate-800 rounded-lg p-2 mt-1 outline-none focus:border-pink-500 dark:focus:border-teal-500 resize-none text-slate-900 dark:text-white" /></div>
              ...
              <div><label className="text-slate-900 font-bold dark:text-pink-600 dark:text-slate-500 text-xs uppercase font-semibold">Persona muy significativa</label><input type="text" name="persona_significativa" defaultValue={entrevista?.persona_significativa} className="w-full border border-purple-300 dark:bg-slate-950 dark:border-slate-800 rounded-lg p-2.5 mt-1 outline-none focus:border-pink-500 dark:focus:border-teal-500 text-slate-900 dark:text-white" /></div>
              ...
              <div className="col-span-2"><label className="text-slate-900 font-bold dark:text-pink-600 dark:text-slate-500 text-xs uppercase font-semibold">Describir cÃ³mo es un dÃ­a de su vida</label><textarea name="dia_de_vida" defaultValue={entrevista?.dia_de_vida} rows="2" className="w-full border border-purple-300 dark:bg-slate-950 dark:border-slate-800 rounded-lg p-2 mt-1 outline-none focus:border-pink-500 dark:focus:border-teal-500 resize-none text-slate-900 dark:text-white" /></div>
            </div>
          </section>
