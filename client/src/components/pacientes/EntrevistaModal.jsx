          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-purple-100/50 dark:bg-slate-900 p-5 rounded-xl border border-purple-300 dark:border-slate-800">
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-3 text-sm font-medium"><input type="checkbox" name="motricidad_acorde" defaultChecked={entrevista?.motricidad_acorde} className="accent-teal-600 dark:accent-teal-500 w-4 h-4" /> ¿Es acorde a la edad?</label>
